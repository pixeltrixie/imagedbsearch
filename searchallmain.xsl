...
<tr><td colspan="2"><h3>Number of Image Results: <xsl:value-of select="count(image[@c=$checkbox1 and @e&lt;=$radio1high and @e>=$radio1low and @f&lt;=$radio1ahigh and @f>=$radio1alow] | image[@c=$checkbox2 and @e&lt;=$radio1high and @e>=$radio1low and @f&lt;=$radio1ahigh and @f>=$radio1alow] | image[@c=$checkbox1 and @h&lt;=$radio2high and @h>=$radio2low] | image[@c=$checkbox2 and @h&lt;=$radio2high and @h>=$radio2low])"/></h3></td></tr>
<xsl:apply-templates select="image[@c=$checkbox1 and @e&lt;=$radio1high and @e>=$radio1low and @f&lt;=$radio1ahigh and @f>=$radio1alow] | image[@c=$checkbox2 and @e&lt;=$radio1high and @e>=$radio1low and @f&lt;=$radio1ahigh and @f>=$radio1alow] | image[@c=$checkbox1 and @h&lt;=$radio2high and @h>=$radio2low] | image[@c=$checkbox2 and @h&lt;=$radio2high and @h>=$radio2low]">		
